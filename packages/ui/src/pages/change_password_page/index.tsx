  ...
  render() {
    ...
    return (
      <div>
        ...
        <List>
          <List.Item>
            <InputItem labelNumber={20} type="password" onChange={this.handleInputOldPassword}>
              Current Password
            </InputItem>
            <InputItem labelNumber={20} type="password" onChange={this.handleInputNewPassword}>
              New Password
            </InputItem>
            <InputItem labelNumber={20} type="password" onChange={this.handleInputNewPassword1}>
              Confirm Password
            </InputItem>
          </List.Item>
