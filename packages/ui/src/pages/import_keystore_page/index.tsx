  ...
  render() {
    ...
    return (
      <div>
        ...
        <List>
          <div>
            <InputItem labelNumber={20} type="text" onChange={this.handleInputWalletName}>
              Wallet Name
            </InputItem>
          </div>
          <div>
            <InputItem labelNumber={20} type="password" onChange={this.handleInputPassword}>
              Password
            </InputItem>
          </div>
          <div className={commonStyles.ops}>
            <Button size="small" type="primary" className={commonStyles.primaryButton} onClick={this.handleConfirm}>
              Confirm
            </Button>
          </div>
        </List>
