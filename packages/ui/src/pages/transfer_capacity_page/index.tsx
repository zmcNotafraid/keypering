...
const TransferCapacityPage = (props: any) => {
  ...
  }, [receiverAddress, senderAddress, amount, addresses, history])
  useEffect(() => {
    ;(async () => {
      const manager = WalletManager.getInstance()
        ...
        return {
          label: (
            <div style={{ width: '100%', display: 'flex' }}>
              ...
              <div>
                Free: <Balance value={addr.freeAmount} /> CKB
              </div>
            </div>
          ),
          value: addr.address,
    ...
    <div>
      ...
      <div className={styles.body}>
          ...
          >
            <List.Item arrow="horizontal">
              ...
              <div>
                ...
                <Balance value={pickerFreeAmount || 0} /> CKB
              </div>
            </List.Item>
          </Picker>
        </div>
        ...
        <div className={commonStyles.ops}>
          <Button size="small" className={commonStyles.cancelButton} onClick={() => history.goBack()}>
            Cancel
          </Button>
          <Button size="small" type="primary" className={commonStyles.primaryButton} onClick={handleConfirm}>
            Confirm
          </Button>
        </div>
      </div>
